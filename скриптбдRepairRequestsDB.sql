...
/****** Object:  Database [RepairRequestsDB]    Script Date: 05.11.2024 16:36:24 ******/
CREATE DATABASE [RepairRequestsDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'RepairRequestsDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\RepairRequestsDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'RepairRequestsDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\RepairRequestsDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [RepairRequestsDB] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [RepairRequestsDB] SET RECOVERY SIMPLE 
GO
